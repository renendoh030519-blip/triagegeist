...
train = pd.read_csv(r'C:\Users\81702\Kaggle\triagegeist\train.csv')
test  = pd.read_csv(r'C:\Users\81702\Kaggle\triagegeist\test.csv')
cc    = pd.read_csv(r'C:\Users\81702\Kaggle\triagegeist\chief_complaints.csv')
ph    = pd.read_csv(r'C:\Users\81702\Kaggle\triagegeist\patient_history.csv')
sub   = pd.read_csv(r'C:\Users\81702\Kaggle\triagegeist\sample_submission.csv')
...
plt.savefig(r'C:\Users\81702\Kaggle\triagegeist\fig1_overview.png',
...
plt.tight_layout()
plt.savefig(r'C:\Users\81702\Kaggle\triagegeist\fig2_decision_support.png',
            dpi=150, bbox_inches='tight')
...
plt.savefig(r'C:\Users\81702\Kaggle\triagegeist\fig3_provider_analysis.png',
            dpi=150, bbox_inches='tight')
...
sub.to_csv(r'C:\Users\81702\Kaggle\triagegeist\submission.csv', index=False)
